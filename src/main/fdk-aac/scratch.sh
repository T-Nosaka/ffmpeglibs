...
#what log.h
mkdir libSBRdec/include/log
echo '#define android_errorWriteLog(a,b)' > libSBRdec/include/log/log.h
...
make_android() {
  ...
  cp -rp libAACenc/include ${OUTPUT_DIR}/${NDKARCH}/fdk-aac
  cp -rp libAACdec/include/* ${OUTPUT_DIR}/${NDKARCH}/fdk-aac/.
  cp -rp libSYS/include/* ${OUTPUT_DIR}/${NDKARCH}/fdk-aac/.
...
#ABI armv7a
make_android armv7a-linux-androideabi arm armeabi-v7a "-fPIC" ""

#ABI aarch64
make_android aarch64-linux-android aarch64 arm64-v8a "-fPIC" ""

#ABI x86
#make_android i686-linux-android x86_32 x86 "-fPIC" ""
